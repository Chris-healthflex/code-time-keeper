// @ts-nocheck — ported from JS; imperative Three.js setup resists strict typing
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        if (liquidEffect) (liquidEffect.uniforms as Map<string, THREE.Uniform<number>>).get('uTime')!.value = uniforms.uTime.value;
